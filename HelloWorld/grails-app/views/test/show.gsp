	...
	<body>
		...
		<div id="show-test" class="content scaffold-show" role="main">
			...
			<ol class="property-list test">
				...
				<g:if test="${testInstance?.state}">
				<li class="fieldcontain">
					<span id="state-label" class="property-label"><g:message code="test.state.label" default="State" /></span>
					
						<span class="property-value" aria-labelledby="state-label"><g:fieldValue bean="${testInstance}" field="state"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${testInstance?.url}">
				<li class="fieldcontain">
					<span id="url-label" class="property-label"><g:message code="test.url.label" default="Url" /></span>
					
						<span class="property-value" aria-labelledby="url-label"><g:fieldValue bean="${testInstance}" field="url"/></span>
